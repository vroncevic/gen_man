...
Copyright
    ...
    gen_man is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'gen_mandoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_man.tex', 'gen_man Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_man', 'gen_man Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_man', 'gen_man Documentation', author, 'gen_man',
